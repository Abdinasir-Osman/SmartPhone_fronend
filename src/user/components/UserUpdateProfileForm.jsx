...
export default function UserUpdateProfileForm({ profile }) {
  ...
  const handleEditClick = () => {
    if (editing) {
      // If already in edit mode, trigger file input
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {editing ? (
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow w-full max-w-xs mx-auto sm:mx-auto my-6 sm:my-8 text-center space-y-3 px-4">
            ...
            {/* Role Badge */}
            <span className="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-gray-200 text-gray-700 mt-1">
              User
            </span>
          </div>
        )}
